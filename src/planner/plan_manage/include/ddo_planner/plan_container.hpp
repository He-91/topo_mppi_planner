...
#include <ddo_traj_utils/polynomial_traj.h>
...
namespace ego_planner
{
  ...
  struct PlanParameters
  {
    ...
    double max_vel_z_, max_acc_z_;        // Z-axis independent limits (for extreme speed scenarios)
    double ctrl_pt_dist;                  // distance between adjacient B-spline control points
    double feasibility_tolerance_;        // permitted ratio of vel/acc exceeding limits
    double planning_horizen_;
    
    /* Multi-topology MPPI optimization */
    bool use_multi_topo_mppi_optimization;  // If true, optimize selected topology-ranked paths with MPPI and select best
